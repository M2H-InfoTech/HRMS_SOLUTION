       ...
       .FirstOrDefaultAsync (e => e.EmpId == EmployeeType.EmpID);
        ...
        public async Task<string> InsertQualification (QualificationTableDto Qualification, string FirstEntityID, int EmpEntityIds)
            ...
            if (WorkFlowNeed == "Yes")
                ...
                var codeID = GetSequence (Qualification.Emp_Id ?? 0, TransactionID, FirstEntityID, EmpEntityIds);
                ...
                var qualificationApproval = new HrEmpQualificationApprl
                    ...
                    EmpId = Qualification.Emp_Id ?? 0,
                    Course = Qualification.Course,
                    University = Qualification.University,
                    InstName = Qualification.Inst_Name,
                    //DurFrm = Qualification.Dur_Frm,
                    DurFrm = DateTime.TryParse (Qualification.Dur_Frm, out var tempDurFrm) ? tempDurFrm : (DateTime?)null,
                    DurTo = DateTime.TryParse (Qualification.Dur_To, out var tempDurTo) ? tempDurTo : (DateTime?)null,

                    // DurTo = Qualification.Dur_To,
                    YearPass = Qualification.Year_Pass,
                    MarkPer = Qualification.Mark_Per,
                ...
                Qualification.Qlf_id = qualificationApproval.QlfId;
                ...
                if (optionenb == 1)
                    ...
                    var qualification = new HrEmpQualification
                        ...
                        University = Qualification.University,
                        InstName = Qualification.Inst_Name,
                        DurFrm = DateTime.TryParse (Qualification.Dur_Frm, out var tempDurFrm1) ? tempDurFrm1 : (DateTime?)null,
                        DurTo = DateTime.TryParse (Qualification.Dur_To, out var tempDurTo1) ? tempDurTo1 : (DateTime?)null,
                    ...
                    _context.SaveChanges ( );
                    Qualification.Qlf_id = qualification.QlfId;
                    ...
                    var qualification = new HrEmpQualification
                        ...
                        University = Qualification.University,
                        InstName = Qualification.Inst_Name,
                        DurFrm = DateTime.TryParse (Qualification.Dur_Frm, out var tempDurFrm2) ? tempDurFrm2 : (DateTime?)null,
                        DurTo = DateTime.TryParse (Qualification.Dur_To, out var tempDurTo2) ? tempDurTo2 : (DateTime?)null,
                        YearPass = Qualification.Year_Pass,
                        MarkPer = Qualification.Mark_Per,
                        Class = Qualification.Class,
                        Subjects = Qualification.Subjects,
                ...
                var empMaster = _context.HrEmpMasters.FirstOrDefault (e => e.EmpId == Qualification.Emp_Id);
                if (empMaster != null)
                    {
